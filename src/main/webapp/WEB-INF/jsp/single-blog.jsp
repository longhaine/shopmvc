   ...
   <!-- ##### Blog Wrapper Area Start ##### -->
    <div class="single-blog-wrapper">
        ...
        <div class="single-blog-post-thumb">
            <img src="${pageContext.request.contextPath}/img/bg-img/bg-7.jpg" alt="">
        </div>
        ...
        <div class="single-blog-content-wrapper d-flex">
            ...
            <div class="related-blog-post">
                ...
                <div class="single-related-blog-post">
                    <img src="${pageContext.request.contextPath}/img/bg-img/rp1.jpg" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="${pageContext.request.contextPath}/img/bg-img/rp2.jpg" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="${pageContext.request.contextPath}/img/bg-img/rp3.jpg" alt="">
                    <a href="#">
                ...
                <!-- Single Related Blog Post -->
                <div class="single-related-blog-post">
                    <img src="${pageContext.request.contextPath}/img/bg-img/rp4.jpg" alt="">
                    <a href="#">
