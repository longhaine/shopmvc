...
<c:if test="${not empty requestScope.productList }">
	<c:set var="productCount" value="${requestScope.productList.size() }"></c:set>
</c:if>
    ...
    <div class="breadcumb_area bg-img" style="background-image: url(img/bg-img/breadcumb.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center" page="${page}">
                        <h2>${paras.category}</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="shop_sidebar_area">
                        ...
                        <div class="widget catagory mb-50">
                            ...
                            <p><a href="search?q=${param.q }">All</a></p>
                            <!--  Catagories  -->
                                ...
                                <ul id="menu-content2" class="menu-content collapse show">
                                    ...
                                    <li data-toggle="collapse" data-target="#View by Category">
                                        ...
                                        <ul class="sub-menu collapse show" id="View by Category">
                                            ...
                                            <li><a href="?category=${category.name }&q=${param.q}">${category.name }</a></li>
                                            </c:forEach>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 items">
                                <div class="single-product-wrapper" id="${product.id }" price="${product.price }">
                                    ...
                                    <div class="product-img">
                                        ...
                                        <!-- Hover Thumb -->
                                        <img class="hover-img" src="${product.image }2.jpg" alt="">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                <a href="#" onclick="addCart(${product.id },'${product.name }','${product.price }','${product.image }1.jpg','${product.brand.name }')" class="btn essence-btn">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
